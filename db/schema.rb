...
ActiveRecord::Schema.define(version: 2020_03_18_070037) do
  ...
  create_table "article_catgories", force: :cascade do |t|
    t.string "name"
  end
  ...
  create_table "table_article_catgories", force: :cascade do |t|
  end
